...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/net/NetworkStatsService$PerformPollAsyncThread;
    }
.end annotation
...
.method static synthetic -get5(Lcom/android/server/net/NetworkStatsService;)Landroid/util/TrustedTime;
    .locals 1
...
.method private performPoll(I)V
    ...
    .prologue
    .line 1143
    new-instance v0, Lcom/android/server/net/NetworkStatsService$PerformPollAsyncThread;

    const-string/jumbo v1, "PerformPoll Async Thread"

    invoke-direct {v0, p0, v1, p1}, Lcom/android/server/net/NetworkStatsService$PerformPollAsyncThread;-><init>(Lcom/android/server/net/NetworkStatsService;Ljava/lang/String;I)V

    .line 1144
    .local v0, "thr":Lcom/android/server/net/NetworkStatsService$PerformPollAsyncThread;
    invoke-virtual {v0}, Lcom/android/server/net/NetworkStatsService$PerformPollAsyncThread;->start()V
...
.method public systemReady()V
    ...
    invoke-interface {v1}, Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;->getDevConfig()Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;

    move-result-object v1

    invoke-direct {p0, v0, v1, v2}, Lcom/android/server/net/NetworkStatsService;->buildRecorder(Ljava/lang/String;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;Z)Lcom/android/server/net/NetworkStatsRecorder;
    ...
    invoke-interface {v1}, Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;->getXtConfig()Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;
    ...
    invoke-interface {v1}, Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;->getUidConfig()Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;
    ...
    invoke-interface {v1}, Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;->getUidTagConfig()Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;

    move-result-object v1

    invoke-direct {p0, v0, v1, v5}, Lcom/android/server/net/NetworkStatsService;->buildRecorder(Ljava/lang/String;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings$Config;Z)Lcom/android/server/net/NetworkStatsRecorder;
    ...
    .line 363
    .local v9, "tetherFilter":Landroid/content/IntentFilter;
    iget-object v0, p0, Lcom/android/server/net/NetworkStatsService;->mContext:Landroid/content/Context;
    ...
    .line 367
    .local v7, "pollFilter":Landroid/content/IntentFilter;
    iget-object v0, p0, Lcom/android/server/net/NetworkStatsService;->mContext:Landroid/content/Context;
    ...
    .line 379
    .local v8, "shutdownFilter":Landroid/content/IntentFilter;
    iget-object v0, p0, Lcom/android/server/net/NetworkStatsService;->mContext:Landroid/content/Context;
    ...
    .end local v7    # "pollFilter":Landroid/content/IntentFilter;
    .end local v8    # "shutdownFilter":Landroid/content/IntentFilter;
    .end local v9    # "tetherFilter":Landroid/content/IntentFilter;
    ...
    .restart local v7    # "pollFilter":Landroid/content/IntentFilter;
    .restart local v8    # "shutdownFilter":Landroid/content/IntentFilter;
    .restart local v9    # "tetherFilter":Landroid/content/IntentFilter;
