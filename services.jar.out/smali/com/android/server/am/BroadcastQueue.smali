...
.method private final isUserOfReceiverStarted(Landroid/content/pm/ResolveInfo;)Z
    .locals 4
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/am/UserController;->hasStartedUserState(I)Z
    ...
    const-string/jumbo v3, "The user["
    ...
    const-string/jumbo v3, "] of receiver:"
    ...
    .line 1302
    const-string/jumbo v3, " is not started, skip it !"
...
.method private final resetBroadcastStateAndContinueDelivery(Lcom/android/server/am/BroadcastRecord;)V
    .locals 7
    .param p1, "r"    # Lcom/android/server/am/BroadcastRecord;
...
.method final processNextBroadcast(Z)V
    ...
    .line 1113
    invoke-virtual {v4, v6, v7}, Lcom/android/server/am/UserController;->isUserRunningLocked(II)Z
    :try_end_d
    ...
    .line 1117
    const-string/jumbo v7, " : user is stopped"
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/BroadcastQueue;->resetBroadcastStateAndContinueDelivery(Lcom/android/server/am/BroadcastRecord;)V
    :try_end_14
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/BroadcastQueue;->isUserOfReceiverStarted(Landroid/content/pm/ResolveInfo;)Z
