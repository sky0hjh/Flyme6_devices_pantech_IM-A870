...
.field static final MAX_SERVICE_COUNT:I = 0x2710
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;I)I
    ...
    .line 913
    .local v36, "res":Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    if-nez v36, :cond_9
    ...
    .end local v32    # "isCallerSystem":Z
    .end local v36    # "res":Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    .local v26, "clientIntent":Landroid/app/PendingIntent;
    :cond_5
    const/16 v32, 0x0
    ...
    .line 902
    .end local v26    # "clientIntent":Landroid/app/PendingIntent;
    .restart local v32    # "isCallerSystem":Z
    :cond_6
    new-instance v4, Ljava/lang/SecurityException;
    ...
    .line 916
    .restart local v36    # "res":Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    :cond_9
    ...
    .line 941
    .local v37, "serviceRecord":Lcom/android/server/am/ServiceRecord;
    ...
    .end local v37    # "serviceRecord":Lcom/android/server/am/ServiceRecord;
    :cond_d
    ...
    .line 1001
    .local v30, "ibinder":Landroid/os/IBinder;
    ...
    .line 1002
    .local v33, "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/ConnectionRecord;>;"
    if-eqz v33, :cond_e
    ...
    const-string/jumbo v8, " has already bind "
    ...
    .line 1004
    const-string/jumbo v8, " connections. Not allow to bind more."
    ...
    .line 1019
    .local v38, "stracker":Lcom/android/internal/app/procstats/ServiceState;
    if-eqz v38, :cond_10
    ...
    .line 1026
    .end local v38    # "stracker":Lcom/android/internal/app/procstats/ServiceState;
    :cond_10
    move-object/from16 v0, p0
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IILjava/lang/String;I)Landroid/content/ComponentName;
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/server/am/UserController;->isUserRunningLocked(II)Z
    ...
    iget-object v5, v0, Lcom/android/server/am/ServiceRecord;->pendingStarts:Ljava/util/ArrayList;
    ...
    const-string/jumbo v6, " has already start "
    ...
    .line 386
    const-string/jumbo v6, " services. Not allow to start more."
