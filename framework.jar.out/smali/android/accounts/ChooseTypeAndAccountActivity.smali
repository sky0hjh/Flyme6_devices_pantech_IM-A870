...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 298
    iget-object v8, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mAccounts:Ljava/util/ArrayList;
    ...
    iput-object v8, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mAccounts:Ljava/util/ArrayList;
    ...
    .line 327
    const-string/jumbo v8, "authAccount"
    ...
    .line 332
    invoke-virtual {v8, v9, v10}, Landroid/accounts/AccountManager;->getAccountsForPackage(Ljava/lang/String;I)[Landroid/accounts/Account;

    move-result-object v5

    .line 334
    .local v5, "currentAccounts":[Landroid/accounts/Account;
    new-instance v7, Ljava/util/HashSet;

    invoke-direct {v7}, Ljava/util/HashSet;-><init>()V

    .line 335
    .local v7, "preExistingAccounts":Ljava/util/Set;, "Ljava/util/Set<Landroid/accounts/Account;>;"
    ...
    .end local v0    # "account":Landroid/accounts/Account;
    .end local v2    # "accountName":Ljava/lang/String;
    .end local v5    # "currentAccounts":[Landroid/accounts/Account;
    .end local v7    # "preExistingAccounts":Ljava/util/Set;, "Ljava/util/Set<Landroid/accounts/Account;>;"
    :cond_f
    if-nez v2, :cond_10
    ...
    .restart local v5    # "currentAccounts":[Landroid/accounts/Account;
    .restart local v7    # "preExistingAccounts":Ljava/util/Set;, "Ljava/util/Set<Landroid/accounts/Account;>;"
    :cond_11
    add-int/lit8 v8, v8, 0x1
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 250
    const-string/jumbo v1, "existingAccounts"
