...
.method private declared-synchronized initalizeChannel(Landroid/content/Context;Landroid/os/Looper;Landroid/net/wifi/p2p/WifiP2pManager$ChannelListener;Landroid/os/Messenger;)Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    .locals 3
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pManager;->mChannel:Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    ...
    iput-object v0, p0, Landroid/net/wifi/p2p/WifiP2pManager;->mChannel:Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    ...
    iget-object v1, p0, Landroid/net/wifi/p2p/WifiP2pManager;->mChannel:Landroid/net/wifi/p2p/WifiP2pManager$Channel;

    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pManager$Channel;->-get2(Landroid/net/wifi/p2p/WifiP2pManager$Channel;)Landroid/net/wifi/p2p/WifiP2pManager$Channel$P2pHandler;

    move-result-object v1

    invoke-virtual {v0, p1, v1, p4}, Lcom/android/internal/util/AsyncChannel;->connectSync(Landroid/content/Context;Landroid/os/Handler;Landroid/os/Messenger;)I
