...
.method public requestSendAccessibilityEvent(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    iget-boolean v9, p0, Landroid/view/ViewRootImpl;->mPausedForTransition:Z
    ...
    :goto_0
    :try_start_0
    iget-object v9, p0, Landroid/view/ViewRootImpl;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;

    invoke-virtual {v9, p2}, Landroid/view/accessibility/AccessibilityManager;->sendAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v9, v0}, Landroid/view/View;->findViewByAccessibilityId(I)Landroid/view/View;

    move-result-object v5

    .line 6687
    .local v5, "source":Landroid/view/View;
    if-eqz v5, :cond_2
    ...
    .line 6694
    invoke-virtual {v4, v9}, Landroid/view/accessibility/AccessibilityNodeProvider;->createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :goto_1
    invoke-virtual {p0, v5, v3}, Landroid/view/ViewRootImpl;->setAccessibilityFocus(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    :cond_3
    invoke-virtual {v4, v8}, Landroid/view/accessibility/AccessibilityNodeProvider;->createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;

    move-result-object v3

    .restart local v3    # "node":Landroid/view/accessibility/AccessibilityNodeInfo;
    goto :goto_1
    ...
    .end local v5    # "source":Landroid/view/View;
    ...
    .line 6708
    .restart local v5    # "source":Landroid/view/View;
    if-eqz v5, :cond_2
    ...
    const-string/jumbo v10, "Failed to send Accessibility Event. "
